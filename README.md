...
>> Included Image Pairs
    ...
    To use your own pair of images, simply place both into this directory and run the code using one as the source and the other as the target.

>> simpix.cpp

    The current setup of the program is best for smaller images 640x480 or smaller, although the values of nt, ntherm, and nsweep on L201-L203 can produce better results for larger images if the output is not as good as for smaller images.
